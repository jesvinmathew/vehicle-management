    ...
    <ul id="itemContainer">
        ...
        $this->db->limit(21);
        $onroad_usedCar = $this->db->get_where('model', 'model.vtype_id = 2');
        $i = 0;
        ...
        ?> ">
                        <div class="block1" >
                         ...
                         <div class="col-xs-15" style="padding:90px; padding-left:60px;">
                            <a href="#myModal" class="btn details fullview" get="viewnew" value="<?= $usCar->model_id ?>"  data-toggle="modal" data-target="#myModal" id="<?= $usCar->model_id ?>" >details</a></div>
                            </div>
                            <div class="title">
